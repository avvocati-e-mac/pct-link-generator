...
Versione attuale: **v0.6.1**

| Sistema operativo | File da scaricare |
|---|---|
| 🍎 **macOS — Apple Silicon** (M1/M2/M3/M4) | [PCT-Link-Generator-0.6.1-arm64.dmg](https://github.com/avvocati-e-mac/pct-link-generator/releases/download/v0.6.1/PCT-Link-Generator-0.6.1-arm64.dmg) |
| 🍎 **macOS — Intel** (x64) | [PCT-Link-Generator-0.6.1.dmg](https://github.com/avvocati-e-mac/pct-link-generator/releases/download/v0.6.1/PCT-Link-Generator-0.6.1.dmg) |
| 🪟 **Windows** (x64) | [PCT-Link-Generator-Setup-0.6.1.exe](https://github.com/avvocati-e-mac/pct-link-generator/releases/download/v0.6.1/PCT-Link-Generator-Setup-0.6.1.exe) |
| 🐧 **Linux** (x64) | [PCT-Link-Generator-0.6.1.AppImage](https://github.com/avvocati-e-mac/pct-link-generator/releases/download/v0.6.1/PCT-Link-Generator-0.6.1.AppImage) |
...
```bash
chmod +x PCT-Link-Generator-0.6.1.AppImage
```

Poi avvialo con:

```bash
./PCT-Link-Generator-0.6.1.AppImage
```
...
- [x] v0.6.1 — Fix badge versione nell'header: costante IPC mancante nel preload causava la visualizzazione del numero obsoleto
